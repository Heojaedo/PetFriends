						...
						<table class="table_post" style="width:800px;border:1px solid #e3e3e3;">
							<tr>
								<td align=center>
									...
									<input type="hidden" name="petsittername" value="${info.username}">
									<table style="margin-top:40px;border:0px;">
										<tr>
											<td align=center><img src="/upload/${info.photo}" style="border-radius:3px;" onload="resize(this)"></td>
										</tr>
										<tr>
									...
									<table style="margin-top:40px;width:600px;border:0px;">
										<tr>
											<td><input class="post_title" name="title" id="title" placeholder="프로필 제목을 입력해주세요."></td>
										</tr>
										<tr>
										...
										<tr>
											<td><textarea class="post_introduce" name="introduce" id="introduce"></textarea></td>
										</tr>
										<tr>
											<td><div style="height:30px;"></div></td>
										</tr>
										...
										<tr>
											<td><input class="post_title" name="addr" id="addr" placeholder="간략주소) 부산시 동래구 온천동"></td>
										</tr>
										<tr>
											<td><div style="height:10px;"></div></td>
										</tr>
										...
										<tr>
											<td>
												<input type="radio" name="op1" id="op1_1" value="아파트" onchange="op1_change()"> <label for="op1_1">아파트</label>
												<input type="radio" name="op1" id="op1_2" value="오피스텔" onchange="op1_change()"> <label for="op1_2">오피스텔</label>
												<input type="radio" name="op1" id="op1_3" value="단독 주택" onchange="op1_change()"> <label for="op1_3">단독 주택</label>
												<input type="radio" name="op1" id="op1_4" value="빌라" onchange="op1_change()"> <label for="op1_4">빌라</label>
												<input type="radio" name="op1" id="op1_5" value="원룸" onchange="op1_change()"> <label for="op1_5">원룸</label>
										...
										<tr>
											<td>
												<input type="radio" name="op2" id="op2_1" value="있어요"> <label for="op2_1">있어요</label>
												<input type="radio" name="op2" id="op2_2" value="없어요"> <label for="op2_2">없어요</label>
											</td>
										</tr>
										<tr>
											<td><div style="height:30px;"></div></td>
										...
										<tr>
											<td>
												<input type="radio" name="op3" id="op3_1" value="있어요"> <label for="op3_1">있어요</label>
												<input type="radio" name="op3" id="op3_2" value="없어요"> <label for="op3_2">없어요</label>
											</td>
										</tr>
										<tr>
											<td><div style="height:30px;"></div></td>
										...
										<tr>
											<td>
												<input type="radio" name="op4" id="op4_1" value="있어요"> <label for="op4_1">있어요</label>
												<input type="radio" name="op4" id="op4_2" value="없어요"> <label for="op4_2">없어요</label>
											</td>
										</tr>
										<tr>
											<td><div style="height:30px;"></div></td>
										...
										<tr>
											<td><input class="post_price" name="price" id="price" placeholder="이용금액을 입력해주세요."></td>
										</tr>
										<tr>
											<td><div style="height:30px;"></div></td>
										</tr>
										...
										<tr>
											<td align=center><button class="btn_form">등록</button></td>
										</tr>
										<tr>
											<td><div style="height:40px;"></div></td>
										</tr>
