...
<input type="hidden" name="petsittername" value="${petsittername.username}">
<table width=100%>
	<tr>
		<td align=center>
				...
				<tr>
					<td align=center>
						<table class="table_join_form" style="width:1200px;border:1px solid #e3e3e3;">
							...
							<tr>
								<td align=center><input class="input_review_title" id="title" name="title" placeholder="제목"></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="padding:30px;">
									<textarea class="inputStyle" id="editor" name="contents"></textarea>
									<script>
										ClassicEditor
							...
							<tr>
								<td align=center>
									<input class="btn_form" type="submit" id="save" value="작성">
									<input class="btn_form2" type="button" value="취소" onclick="history.back()">
								</td>
							</tr>
							<tr>
								<td><div style="height:40px;"></div></td>
