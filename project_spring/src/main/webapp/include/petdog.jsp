					...
					<td align=center>
						<table style="width:500px;border:0px;">
							<tr>
								...
								<td align=left width=250px><input class="input_pet" style="width:230px;" name="breed" id="breed" placeholder="견종" maxlength="16"></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td align=center>
						<table style="width:500px;border:0px;">
							...
							<tr>
								<td align=left>
									<input type="radio" name="registry" id="regi1" value="1" checked> <label for="regi1">내장형</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="registry" id="regi2" value="2"> <label for="regi2">외장형</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="registry" id="regi3" value="3"> <label for="regi3">등록인식표</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="registry" id="regi4" value="4"> <label for="regi4">하지않음</label>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td align=center>
						<table style="width:500px;border:0px;">
							...
							<tr>
								<td align=left>
									<input type="radio" name="q2" id="q2_1" value="1" checked> <label for="q2_1">매우좋아요</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="q2" id="q2_2" value="2"> <label for="q2_2">좋아요</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="q2" id="q2_3" value="3"> <label for="q2_3">보통</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="q2" id="q2_4" value="4"> <label for="q2_4">수줍어해요</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="q2" id="q2_5" value="5"> <label for="q2_5">공격적이예요</label>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td align=center>
						<table style="width:500px;border:0px;">
							...
							<tr>
								<td align=left>
									<input type="radio" name="q3" id="q3_1" value="1" checked> <label for="q3_1">예</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="q3" id="q3_2" value="2"> <label for="q3_2">보통</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="q3" id="q3_3" value="3"> <label for="q3_3">아니오</label>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td align=center>
						<table style="width:500px;border:0px;">
							...
							<tr>
								<td align=left>
									<input type="radio" name="q4" id="q4_1" value="1" checked> <label for="q4_1">예</label>
									&nbsp;&nbsp;&nbsp;
									<input type="radio" name="q4" id="q4_2" value="2"> <label for="q4_2">아니오</label>
								</td>
							</tr>
						</table>
					</td>
